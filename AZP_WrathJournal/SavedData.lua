...
AZP.WrathJournal.RetailSectionData = {
    ...
    [3] = {
        ...
        adds = {
            { name = "Mago de Batalla Enemigo", desc = "Aparece periódicamente en la nave rival y catea 'Congelación Precipitada', inhabilitando los cañones de tu nave hasta morir." },
    ...
    [8] = {
        ...
        heroic = "• PRISIÓNDE SOMBRAS: Moverse otorga un debuff acumulativo que inflige daño de Sombra creciente por cada paso dado.",
